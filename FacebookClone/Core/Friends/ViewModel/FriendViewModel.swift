...
final class FriendViewModel: ObservableObject {
    ...
    @Published var users: [User] = [
        .init(id: "0", firstName: "Cardinal", familyName: "312", email: "manasov7777@gmail.com", profileImageName: "me", age: 28, gerder: "male", friendsIds: ["3"], friendsRequestsIDs: ["1","2","4"], isCurrentUser: true),
        ...
        .init(id: "3", firstName: "Jim", familyName: "Halpert", email: "jim.halpert@gmail.com", profileImageName: "profilePic1", age: 40, gerder: "male", friendsIds: ["0"], friendsRequestsIDs: [], isCurrentUser: false),
